...
module.exports = function (req, res, url) {
	...
	switch (url.pathname) {
		case "/go/movie/": {
			title = "Player";
			attrs = {
				data: "https://dominicjennings.github.io/Animation2025/2025 New/player.swf",
				type: "application/x-shockwave-flash",
				
				id: "Player",
	                        swf: "https://dominicjennings.github.io/Animation2025/2025 New/player.swf",
	                        height: "379",
	                        width: "620",
	                        bgcolor: "#000000",
	                        scale: "exactfit",
			...
			params = {
				flashvars: {
					...
					animationPath: "https://dominicjennings.github.io/Animation2025/2025 New/",
					isEmbed: "0",
					refuser: null,
					utm_source: null,
					uid: null,
				...
				movie: "https://dominicjennings.github.io/Animation2025/2025 New/player.swf",
			};
			break;
		}
